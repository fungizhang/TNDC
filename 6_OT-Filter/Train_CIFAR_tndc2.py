...
# 确保保存目录存在
save_dir = "/mnt/zfj/exp_results/OT-filter"
os.makedirs(save_dir, exist_ok=True)
save_path = os.path.join(save_dir, f"{args.dataset}_{args.noisy_type}_{args.noisy_rate}_tndc2.json")
...
######  tndc
if args.dataset == 'cifar10':
    noisy_label = json.load(open(f'/mnt/zfj/dataset/dino_mod/cifar10/dino_mod_labels_{args.noisy_type}_{args.noisy_rate}.json',"r"))
elif args.dataset == 'cifar100':
    noisy_label = json.load(open(f'/mnt/zfj/dataset/dino_mod/cifar100/dino_mod_labels_{args.noisy_type}_{args.noisy_rate}.json',"r"))
