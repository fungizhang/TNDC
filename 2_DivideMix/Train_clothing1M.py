...
parser.add_argument('--id', default='clothing1M_res50_conf20_mow5_rt15')
parser.add_argument('--data_path', default='/home/zhangfeng/zhangfangjiao/datasets/clothing1m', type=str, help='path to dataset')
